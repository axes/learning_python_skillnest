...
matriz[1][0] = 6
print(matriz)  # Imprime: [[10, 15, 20], [6, 7, 14]]

cantantes[0]["nombre"] = "Enrique Martin Morales"
print(cantantes)  # Imprime: [{'nombre': 'Enrique Martin Morales', 'pais': 'Puerto Rico'}, {'nombre': 'Chayanne', 'pais': 'Puerto Rico'}]

ciudades["México"][2] = "Monterrey"
print(ciudades)  # Imprime: {'México': ['Ciudad de México', 'Guadalajara', 'Monterrey'], 'Chile': ['Santiago', 'Concepción', 'Viña del Mar']}

coordenadas[0]["latitud"] = 9.9355431
print(coordenadas)  # Imprime: [{'latitud': 9.9355431, 'longitud': -84.9399704}]
